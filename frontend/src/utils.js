const domain = "https://tough-melody-334922.uc.r.appspot.com";
...
export const login = (credential, asHost) => {
    ...
    }).then((response) => {                // then is processed after fetch executes (get the response)
         // response is actually generated by fetch or chrome
